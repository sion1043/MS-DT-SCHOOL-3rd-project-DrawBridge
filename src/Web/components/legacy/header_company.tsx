...
export function Header_company() {
            ...
            {/* <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem asChild>
                  <Link href="/company_monitor">구직자 모니터링</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/company_job">채용 공고 모니터링</Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu> */}
            
            <Link href="/company_monitor" className="py-2 hover:text-secondary transition-colors">
              구직자 모니터링
            </Link>
            <Link href="/company_job" className="py-2 hover:text-secondary transition-colors">
              채용 공고 모니터링
            </Link>
