...
export default function LoginPage() {
    ...
    useEffect(() => {
      // 컴포넌트가 마운트된 후에 스타일 적용
      const applyStyles = () => {
        const wrapper = document.querySelector('.wrap_intergranted_login_page') as HTMLElement;
        if (wrapper) {
          // !important를 사용하여 스타일 우선 적용
  ...
  return (
    <>
      <div
        id="content"
        className="intergrated_login_content signup-page"
        style={{
          padding: "0px",
